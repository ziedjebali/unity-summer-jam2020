shader "Minimalist Free/LWRP/Standard" {
	Properties{
		//Texture Module
	...
	SubShader{	
		Tags { "RenderType"="Opaque" "Queue"="Geometry" "RenderPipeline" = "LightweightPipeline" "IgnoreProjector" = "True" "DisableBatching" = "False"}
